...
DeviseTokenAuth.setup do |config|
  ...
  # redirect users after successful password resets. If this param is set, the API will redirect to
  # this value when no value is provided by the client.
  config.default_password_reset_url = 'http://localhost:5000/'
